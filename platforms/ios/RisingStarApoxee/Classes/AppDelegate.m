...
- (BOOL)application:(UIApplication*)application didFinishLaunchingWithOptions:(NSDictionary*)launchOptions
{
    ...
    //Init App with Appoxee Library and Services
    [[AppoxeeManager sharedManager] initManagerWithDelegate:self andOptions:NULL];
    
    //Asks Apple for your push token
    [self appNeedsToRegisterForPush];
    ...
    //Passes luanch options dictionary to Appoxee Library Manager
...
// only valid if RisingStarApoxee-Info.plist specifies a protocol to handle
...
//Returns Appoxee AppSDKID string , as provided in Appoxee's website. Replace XXX with your Key
- (NSString *) AppoxeeDelegateAppSDKID
{
   // return @"52c912733a3e34.54217122";
     return @"52d3bc64e3a896.11684868";
}

//Return the Appoxee SDK App Secret string  , as provided in Appoxee's website. Replace XXX with your Key
- (NSString *) AppoxeeDelegateAppSecret
{
    //return @"52c912733a40b2.34471035";
    return @"52d3bc64e3aa94.87219904";
}

/*
 * Delegate Methods from Appoxee.h
 */
...
{
    //Implement your own code.
    //This method is called when the Appoxee client opens from Push Notification.
